...
class DivaVersionPreference :
    ...
    override val purpose: Int
        get() = R.string.diva_version_purpose

    override val title: Int
        get() = R.string.diva_version
    ...
    override fun getSummary(context: Context): CharSequence? = DivaInfoUtils.getDivaVersion()
