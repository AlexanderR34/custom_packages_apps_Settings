...
class DivaBuildTypePreference :
    ...
    override val purpose: Int
        get() = R.string.diva_build_type_purpose

    override val title: Int
        get() = R.string.diva_build_type
    ...
    override fun getSummary(context: Context): CharSequence? = DivaInfoUtils.getBuildType(context)
