...
class DivaTotalRamPreference :
    ...
    override val purpose: Int
        get() = R.string.diva_total_ram_purpose

    override val title: Int
        get() = R.string.diva_total_ram
    ...
    override fun getSummary(context: Context): CharSequence? = DivaInfoUtils.getTotalRam()
