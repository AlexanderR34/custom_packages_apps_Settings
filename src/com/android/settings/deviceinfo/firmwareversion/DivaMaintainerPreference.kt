...
class DivaMaintainerPreference :
    ...
    override val purpose: Int
        get() = R.string.diva_maintainer_purpose

    override val title: Int
        get() = R.string.diva_maintainer
    ...
    override fun getSummary(context: Context): CharSequence? = DivaInfoUtils.getMaintainer()
