...
class ButtonNavigationSettingsStyleRadioButton(
    context: Context,
    val titleRes: Int,
    val icons: List<Int>,
    val labels: List<Int>,
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        ...
        (holder.findViewById(R.id.order_label) as? TextView)?.setText(titleRes)
    }
    ...
    interface OnClickListener {
        fun onRadioButtonClicked(source: ButtonNavigationSettingsStyleRadioButton)
    }
