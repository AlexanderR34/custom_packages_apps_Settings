...
public class JellyWallpaperLightWaterWavesIntensityPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_light_water_waves_intensity";
    public static final String SETTING_KEY = "jelly_wallpaper_light_water_waves_intensity";
    public static final int DEFAULT_VALUE = 75;

    private SliderPreference mPreference;

    public JellyWallpaperLightWaterWavesIntensityPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public void updateState(Preference preference) {
        ...
        preference.setEnabled(isLightEnabled && isWavesEnabled);
    ...
    public CharSequence getSummary() {
        return mContext.getString(com.android.settings.R.string.jelly_wallpaper_light_water_waves_intensity_summary)
                + " • " + getSliderPosition() + "%";
    }
