...
public class JellyWallpaperInternalTensionPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_internal_tension";
    public static final String SETTING_KEY = "jelly_wallpaper_internal_tension";
    public static final int DEFAULT_VALUE = 65;

    private SliderPreference mPreference;

    public JellyWallpaperInternalTensionPreferenceController(Context context, String key) {
        super(context, key);
    }
