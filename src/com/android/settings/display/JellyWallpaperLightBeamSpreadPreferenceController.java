...
public class JellyWallpaperLightBeamSpreadPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_light_beam_spread";
    public static final String SETTING_KEY = "jelly_wallpaper_light_beam_spread";
    public static final int DEFAULT_VALUE = 50;

    private SliderPreference mPreference;

    public JellyWallpaperLightBeamSpreadPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public CharSequence getSummary() {
        return mContext.getString(com.android.settings.R.string.jelly_wallpaper_light_beam_spread_summary)
                + " • " + getSliderPosition() + "%";
    }
