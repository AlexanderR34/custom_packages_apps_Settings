...
public class JellyWallpaperAmbientOcclusionIntensityPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_ambient_occlusion_intensity";
    public static final String SETTING_KEY = "jelly_wallpaper_ambient_occlusion_intensity";
    public static final int DEFAULT_VALUE = 75;

    private SliderPreference mPreference;

    public JellyWallpaperAmbientOcclusionIntensityPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public void updateState(Preference preference) {
        ...
        boolean isAoEnabled = Settings.System.getInt(
                mContext.getContentResolver(), "jelly_wallpaper_ambient_occlusion", 1) != 0;
        preference.setEnabled(isJellyEnabled && isAoEnabled);
