...
public class JellyWallpaperSurfaceMassPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_surface_mass";
    public static final String SETTING_KEY = "jelly_wallpaper_surface_mass";
    public static final int DEFAULT_VALUE = 50;

    private SliderPreference mPreference;

    public JellyWallpaperSurfaceMassPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public CharSequence getSummary() {
        return mContext.getString(com.android.settings.R.string.jelly_wallpaper_surface_mass_summary)
                + " • " + getSliderPosition() + "%";
    }
