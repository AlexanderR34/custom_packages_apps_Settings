...
public class JellyWallpaperLightAnglePreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_light_angle";
    public static final String SETTING_KEY = "jelly_wallpaper_light_angle";
    public static final int DEFAULT_VALUE = 45;

    private SliderPreference mPreference;

    public JellyWallpaperLightAnglePreferenceController(Context context, String key) {
        super(context, key);
    }
