...
public class JellyWallpaperSnapBackRecoilPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_snapback_recoil";
    public static final String SETTING_KEY = "jelly_wallpaper_snapback_recoil";
    public static final int DEFAULT_VALUE = 75;

    private SliderPreference mPreference;

    public JellyWallpaperSnapBackRecoilPreferenceController(Context context, String key) {
        super(context, key);
    }
