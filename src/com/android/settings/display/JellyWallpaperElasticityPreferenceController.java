...
public class JellyWallpaperElasticityPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_elasticity";
    public static final String SETTING_KEY = "jelly_wallpaper_elasticity";
    public static final int DEFAULT_VALUE = 70;

    private SliderPreference mPreference;

    public JellyWallpaperElasticityPreferenceController(Context context, String key) {
        super(context, key);
    }
