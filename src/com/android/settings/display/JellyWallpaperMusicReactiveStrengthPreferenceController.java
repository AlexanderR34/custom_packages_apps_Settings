...
public class JellyWallpaperMusicReactiveStrengthPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_music_reactive_strength";
    public static final String SETTING_KEY = "jelly_wallpaper_music_reactive_strength";
    public static final int DEFAULT_VALUE = 70;

    private SliderPreference mPreference;

    public JellyWallpaperMusicReactiveStrengthPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public void updateState(Preference preference) {
        ...
        preference.setEnabled(isJellyEnabled && isMusicEnabled);
