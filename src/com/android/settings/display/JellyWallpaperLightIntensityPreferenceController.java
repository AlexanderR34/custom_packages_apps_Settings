...
public class JellyWallpaperLightIntensityPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_light_intensity";
    public static final String SETTING_KEY = "jelly_wallpaper_light_intensity";
    public static final int DEFAULT_VALUE = 75;

    private SliderPreference mPreference;

    public JellyWallpaperLightIntensityPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public CharSequence getSummary() {
        return mContext.getString(com.android.settings.R.string.jelly_wallpaper_light_intensity_summary)
                + " • " + getSliderPosition() + "%";
    }
