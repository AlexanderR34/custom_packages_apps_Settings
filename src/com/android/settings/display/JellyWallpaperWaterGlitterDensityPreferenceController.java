...
public class JellyWallpaperWaterGlitterDensityPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_water_glitter_density";
    public static final String SETTING_KEY = "jelly_wallpaper_water_glitter_density";
    public static final int DEFAULT_VALUE = 70;

    private SliderPreference mPreference;

    public JellyWallpaperWaterGlitterDensityPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public CharSequence getSummary() {
        return mContext.getString(com.android.settings.R.string.jelly_wallpaper_water_glitter_density_summary)
                + " • " + getSliderPosition() + "%";
    }
