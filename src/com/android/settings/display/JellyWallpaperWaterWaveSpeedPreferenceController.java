...
public class JellyWallpaperWaterWaveSpeedPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_water_wave_speed";
    public static final String SETTING_KEY = "jelly_wallpaper_water_wave_speed";
    public static final int DEFAULT_VALUE = 60;

    private SliderPreference mPreference;

    public JellyWallpaperWaterWaveSpeedPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public CharSequence getSummary() {
        return mContext.getString(com.android.settings.R.string.jelly_wallpaper_water_wave_speed_summary)
                + " • " + getSliderPosition() + "%";
    }
