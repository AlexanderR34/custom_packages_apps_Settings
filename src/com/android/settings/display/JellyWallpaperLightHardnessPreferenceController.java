...
public class JellyWallpaperLightHardnessPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_light_hardness";
    public static final String SETTING_KEY = "jelly_wallpaper_light_hardness";
    public static final int DEFAULT_VALUE = 50;

    private SliderPreference mPreference;

    public JellyWallpaperLightHardnessPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public CharSequence getSummary() {
        return mContext.getString(com.android.settings.R.string.jelly_wallpaper_light_hardness_summary)
                + " • " + getSliderPosition() + "%";
    }
