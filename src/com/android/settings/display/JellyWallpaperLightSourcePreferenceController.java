...
public class JellyWallpaperLightSourcePreferenceController extends TogglePreferenceController {

    public static final String KEY = "jelly_wallpaper_light_source";
    public static final String SETTING_KEY = "jelly_wallpaper_light_source_enabled";

    public JellyWallpaperLightSourcePreferenceController(Context context, String key) {
        super(context, key);
    }
