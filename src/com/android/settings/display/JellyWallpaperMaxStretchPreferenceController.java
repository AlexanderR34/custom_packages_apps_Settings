...
public class JellyWallpaperMaxStretchPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_max_stretch";
    public static final String SETTING_KEY = "jelly_wallpaper_max_stretch";
    public static final int DEFAULT_VALUE = 70;

    private SliderPreference mPreference;

    public JellyWallpaperMaxStretchPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public CharSequence getSummary() {
        return mContext.getString(com.android.settings.R.string.jelly_wallpaper_max_stretch_summary)
                + " • " + getSliderPosition() + "%";
    }
