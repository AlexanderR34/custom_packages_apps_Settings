...
public class JellyWallpaperDepthSeparationPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_depth_separation";
    public static final String SETTING_KEY = "jelly_wallpaper_depth_separation";
    public static final int DEFAULT_VALUE = 60;

    private SliderPreference mPreference;

    public JellyWallpaperDepthSeparationPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public void updateState(Preference preference) {
        ...
        boolean isDepthEnabled = Settings.System.getInt(
                mContext.getContentResolver(), "jelly_wallpaper_depth_effect", 0) != 0;
        preference.setEnabled(isJellyEnabled && isDepthEnabled);
