...
public class JellyWallpaperChargingWaveStrengthPreferenceController extends SliderPreferenceController {

    public static final String KEY = "jelly_wallpaper_charging_wave_strength";
    public static final String SETTING_KEY = "jelly_wallpaper_charging_wave_strength";
    public static final int DEFAULT_VALUE = 80;

    private SliderPreference mPreference;

    public JellyWallpaperChargingWaveStrengthPreferenceController(Context context, String key) {
        super(context, key);
    }
    ...
    public void updateState(Preference preference) {
        ...
        boolean isWaveEnabled = Settings.System.getInt(
                mContext.getContentResolver(), "jelly_wallpaper_charging_wave", 1) != 0;
        preference.setEnabled(isJellyEnabled && isWaveEnabled);
