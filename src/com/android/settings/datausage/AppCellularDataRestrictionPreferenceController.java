...
public class AppCellularDataRestrictionPreferenceController extends TogglePreferenceController {

    private final NetworkPolicyManager mPolicyManager;
    private int mUid;

    public AppCellularDataRestrictionPreferenceController(Context context, String key) {
        super(context, key);
