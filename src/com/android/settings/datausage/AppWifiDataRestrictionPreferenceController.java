...
public class AppWifiDataRestrictionPreferenceController extends TogglePreferenceController {

    private final NetworkPolicyManager mPolicyManager;
    private int mUid;

    public AppWifiDataRestrictionPreferenceController(Context context, String key) {
        super(context, key);
